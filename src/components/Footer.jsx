    ...
    <footer>
      ...
      <div className="hidden xxl:flex fixed bottom-[160px] -left-[100px] rotate-90">
        <div className="flex items-center gap-3 text-[#7c7cb3] cursor-pointer">
          <a href="https://www.linkedin.com/in/parasmahla80/"><FaLinkedin size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://github.com/parasmahla1"><FaGithub size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://www.instagram.com/paras_mahla_1/"><FaInstagram size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
      ...
      <div className=" hidden xxl:flex fixed bottom-[190px] right-[-130px] rotate-90">
        <div className="flex items-center gap-3 text-[#7c7cb3]">
          <p className="font-semibold">parasmahla80@gmail.com</p>
